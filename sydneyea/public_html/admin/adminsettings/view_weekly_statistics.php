<?php 
		...
		elseif($flag == "delete")
	{
 	...
 	$pagqry="SELECT * FROM `tbl_side_statistics` WHERE `date` >= (CURDATE()-INTERVAL 6 DAY)";
...
//$limit = 2; 
	...
	$page   = $pager->page; 	
 	...
 	$limqry		= "SELECT * FROM `tbl_side_statistics` WHERE `date` >= (CURDATE()-INTERVAL 6 DAY) order by id DESC  limit $offset,$limit ";
...
<?php 					
          ...
          <tr>
            <td width="97%" align="right" class="test">';
							...
							{       
								echo "<a href=\"view_weekly_statistics.php?sortby=".$SortList."&page=" . ($page - 1) . "\" class='linksnew'>Prev</a>"; 
							}
							...
							{ 
								...
								{	 
									echo "<a href=\"view_weekly_statistics.php?sortby=".$SortList."&page=$i\" class='linksnew'> $i</a>"."</font>"; 
								}
							} 
							...
							{     
								echo "<a href=\"view_weekly_statistics.php?sortby=".$SortList."&page=" . ($page + 1) . "\" class='linksnew'>Next</a>";
							}
					}	echo'</td>
  </tr>
</table>';
