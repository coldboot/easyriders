 ...
 <td>&nbsp;</td>
  ...
  <tr>
           <td colspan="8" align="center" style="padding-left:55px;">
					   <?php
						echo "<a class=\"leftlinks\" href=\"viewcategory.php?sortby=all\">All</a>";?>
									  &nbsp;&nbsp;&nbsp;
									  <?php 		for($ASCII = 65; $ASCII <= 90 ; $ASCII++)
						{				
						  echo "<a class=\"leftlinks\" href=\"viewcategory.php?sortby=".chr($ASCII)."\">".chr($ASCII)."</a>&nbsp;" ."&nbsp;";
						}	
					 ?>		 	</td>
  </tr>
				...
				<div class="hastable">
					...
					?>
						<tr>
						    ...
						    <td style="padding-left:110px;"><?php echo ucfirst($fetch_cat['varCategoryname']);?></td> 
							
							    <td align="center" style="padding-left:55px;"><?php if($fetch_cat['varStatus'] == "Active") { ?>
                                <a href="viewcategory.php?flag=deactive&amp;cid=<?php echo $fetch_cat['catid'];?>"  class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="De-Activate">
								<span class="ui-icon ui-icon-unlocked"></span></a>
                                <?php } else { ?>
                                <a href="viewcategory.php?flag=active&amp;cid=<?php echo $fetch_cat['catid'];?>"  class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Activate">
								<span class="ui-icon ui-icon-locked"></span></a><?php } ?></td> 
						 
						 
						    <td align="center" style="padding-left:28px;"><a href="addcategory.php?flag=edit&amp;cid=<?php echo $fetch_cat['catid'];?>"class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit This Category">
							<span class="ui-icon ui-icon-pencil"></span>
							</a>
							
							</td> 
						    <td align="center" style="padding-left:40px;"><a href="viewcategory.php?flag=delete&amp;cid=<?php echo $fetch_cat['catid'];?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Delete"><span class="ui-icon ui-icon-circle-close" onClick="return calldel('Do You Want To Delete This Category?');"></span></a></td> 
					      </tr> 
						  <?php 
