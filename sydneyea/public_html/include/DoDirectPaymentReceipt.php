...
$insert_order = "INSERT INTO `tbl_karoowquine_checkout` (`intId`,`txtPrice`,`varPayDate`,`varFirstName`,`varLastName`) VALUES ('','$amount','$date','$firstName','$lastName')";
mysql_query($insert_order) or die(mysql_error());
mysql_insert_id();
