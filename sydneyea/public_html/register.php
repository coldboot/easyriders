	...
	else
    {
		...
		else
		{
			...
			$ins_user="INSERT INTO ".MEMBER.
						 "(`intWPid`, `varFirstname`,`varLastname`,`varEmail`,`varPhone`,`varStatus`,`productimage`,`varbiography`,`varridingtime`,`varRidename`,`varoftenrides`,`varbiketype`,`varUsername`,`varPassword`,`cpassword`,`activeid`,`varRegoDate`,`varAcceptTerms`,`varAcceptTermsDate`, `varInsurance`, `varInsuranceOther`) VALUES
						  ('$wp_user_id', '$firstname','$lastname','$email'  ,'$phone'  ,'Active'   ,'$imagename'  ,'$biography'  ,'$ridingtime'  ,'$ridename'  ,'$oftenrides'  ,'$biketype'  ,'$username'  ,'$password'  ,'$cpassword','no'     ,'$timenow'   ,'$acceptterms'   ,'$timenow'         , '$insurance'  , '$insuranceother')";
			...
			else
			{
				...
				<tr><td> Insurance : '.$insurance.' '.$insuranceother.'</td></tr>
                                                    ...
                                                    <table width="100%" border="0" align="left" cellpadding="5" cellspacing="0">
													  ...
													  <tr>
                                                        ...
                                                        <td><select name="insurance">
                                                        	...
                                                        	<option value="yes with Bike NSW">yes with Bike NSW</option>
                                                        	<option value="yes with Bike VIC">yes with Bike VIC</option>
                                                        	<option value="yes with Bike North">yes with Bike North</option>
                                                        	<option value="yes other">yes other</option>
                                                        	</select>
                                                        </td>
                                                      </tr>
													  <tr>
                                                        <td align="right" class="body_style"><strong>Details of Other Insurance</strong></td>
                                                        <td align="right" class="body_style"><strong>:</strong></td>
                                                        <td><input name="insuranceother" type="text" class="text_filed" id="textfield3" /></td>
                                                      </tr>
