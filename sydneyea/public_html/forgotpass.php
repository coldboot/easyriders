...
include("include/constants.php"); 
    ...
    if($_GET['log']=="out") 
		 ...
		 if($_COOKIE['login']=="auto")   header("Location:index.php");
            ...
            <td class="page_mid"><table width="990" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="700" valign="top"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="head_big"><span style="font-size: 20px; font-weight:bold;"><big>Forget Password</big></span></td>
							  ...
							  <?php if($_GET['flg']=="nf"){?>
								<tr>
									<td colspan="2" align="center" style="font-weight:bold; font-size:18px;">Not found your email in our database</td>
								</tr>
								<tr><td>&nbsp;</td></tr>
								<?php }?>
                              
							  
							    <?php if($_GET['flg']=="succ"){?>
								<tr>
									<td colspan="2" align="center" style="font-weight:bold; font-size:18px;">Mail Sent</td>
								</tr>
								<tr><td>&nbsp;</td></tr>
								<?php }?>
								<?php if($_GET['flg']=="cs"){?>
								<tr>
									<td colspan="2" align="center" style="font-weight:bold; font-size:18px;">Cannot send password to your e-mail address</td>
								</tr>
								<tr><td>&nbsp;</td></tr>
								<?php }?>
                                    <tr>
                                          ...
                                          <td><table width="350" border="0" align="center" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                              ...
                                              <td bgcolor="#FFFFFF">
												...
												<form  action="getpwd1.php" method="post" enctype="multipart/form-data" name="login" onSubmit="return vali();">				
											  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                  <tr>
                                                    <td><table border="0" align="center" cellpadding="5" cellspacing="0">
													<tr><td>&nbsp;</td></tr>
                                                      <tr>
                                                        <td align="right" class="body_style"><strong>Email </strong></td>
														
														
													
                                                        <td align="right" class="body_style"><strong>:</strong></td>
                                                      
														<td><input type="text" name="email_to" id="email_to" />	                                                       </td>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td><table border="0" cellspacing="0" cellpadding="3">
                                                          <tr>
                                                            <td>
															  <input type="image" src="images/submit.png" width="69" height="29" border="0" name="login" value="login" /> 
                                                  </td>          
                                                          </tr>
                                                        </table></td>
                                                      </tr>
