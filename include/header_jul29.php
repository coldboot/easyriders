    ...
    <td valign="top"><table width="998" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="top" class="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="419" valign="top"><a href="index.php" style="text-decoration:none;" ><img src="images/logo.png" width="419" height="129"  border="0"/></a></td>
  ...
  <ul>
	...
	<li><a href="index.php?page=<?php echo base64_encode("cms"); ?>&cmsid=<?php echo base64_encode("Contact"); ?>" ><span>Contact</span></a></li>
      ...
      <tr>
        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="334" background="images/banner_bg.jpg">
		
		<div id="red_stripe_wrapper">
			<script type="text/javascript">
	//<![CDATA[
	var num_pages = 4;
	var current_page = 1;
	...
	//]]>
			...
			<div id="left_arrow" class="featured_arrow_div" style="float:left;">
					<a href="#" id="left_arrow_active" onclick="page_left(); return false;"><img alt="Left" rel="nofollow"  src="images/arrow_left.jpg" /></a>

					<img alt="Left" class="inactive_arrow" id="left_arrow_inactive" src="images/arrow_left1.jpg" width="75" height="334" style="display:none;" />
				</div>
				
                <div id="featured_project_images">
				<div id="project_picture_351"><img alt="Homepage with Featured Deal" class="slider_pic_inactive" id="picture_1" src="images/slide1.jpg" width="848" height="334"  /></div>

	
	<div id="project_picture_350"><img alt="Home Page" class="slider_pic_inactive" id="picture_2" src="images/slide1.jpg" width="848" height="334" /></div>

	
	<div id="project_picture_349"><img alt="" class="slider_pic_inactive" id="picture_3" src="images/slide1.jpg" width="848" height="334"  /></a></div>

	
	<div id="project_picture_348"><img alt="" class="slider_pic_inactive" id="picture_4" src="images/slide1.jpg" width="848" height="334" /></div>
					...
					<img alt="Right" class="inactive_arrow" id="right_arrow_inactive" src="images/arrow_right1.jpg" width="75" height="334" style="display:none;" />
				</div>
				</div>
				<script type="text/javascript">
		//<![CDATA[
		...
		//]]>
			...
			<!--<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="75"><a class="click_left_by_166_300" href="javascript:void(0);"><img src="images/arrow_left.jpg" width="75" height="334"  border="0"/></a></td>
                
				<td> <img src="images/slide1.jpg" width="848" height="334" border="0" /></td>
                
								
                <td width="75"><a class="click_right_by_166_300" href="javascript:void(0);">
				<img src="images/arrow_right.jpg" width="75" height="334" border="0" /></a></td>
              </tr>
            </table>-->
	<!--		<div id="scrollLinks">
    <a class="click_left_by_166_300" href="#"><img src="images/aro-lft.gif" width="19" height="9" alt="" border="0" /></a>
    <a class="click_right_by_166_300" href="#"><img src="images/aro-rt.gif" width="19" height="9" alt="" border="0" /></a>
</div>
-->
			</td>
            </tr>