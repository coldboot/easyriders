...
<div id="page-wrapper">
		<div id="main-wrapper">
			<div id="main-content">
			<div class="title">
				<a name="viewcat"></a>	<h3>View Gallery</h3>
				</div>
 ...
 <td>&nbsp;</td>
  ...
  <tr>
           <td colspan="8" align="center" style="padding-left:55px;">
					   <?php
						echo "<a class=\"leftlinks\" href=\"viewgall.php?sortby=all\">All</a>";?>
									  &nbsp;&nbsp;&nbsp;
									  <?php 		for($ASCII = 65; $ASCII <= 90 ; $ASCII++)
						{				
						  echo "<a class=\"leftlinks\" href=\"viewgall.php?sortby=".chr($ASCII)."\">".chr($ASCII)."</a>&nbsp;" ."&nbsp;";
						}	
					 ?>		 	</td>
  </tr>
  ...
  { 
	  if($rType == "active")
	  	$rDisp	=	"Gallery Status Successfully Activated";
	  elseif($rType == "deactive")
	  	$rDisp	=	"Gallery Status Successfully De-Activated";
	  elseif($rType == "delete")
...
?></span>
				...
				<div class="hastable">
					<form name="myform" class="" method="post" action="">
						...
						<?php if($total == 0) {  ?><thead><tr><td colspan="5" align="center">Gallery List Not Found!</td></tr> </thead> <?php }else { ?>                  <thead>
						<tr>
						    <th width="34" align="center">S.No</th>
						    <th width="60" align="left">Gallery</th>
						    <th width="150" align="left">Image Name</th>
						    <th width="150" align="left">Image</th> 
					...
					?>
						<tr>
						    ...
						    <td style="padding-left:20px;"><?php echo ucfirst($fetch_cat['varGallery']);?></td> 
						    <td style="padding-left:20px;"><?php echo ucfirst($fetch_cat['varCategoryname']);?></td> 
							 <td style="padding-left: 70px;"><img src="../../deimage1/<?php echo $fetch_cat['catimage'];?>" border="0" width="75" height="75" align="absmiddle"/></td> 
							    <td align="center" style="padding-left:35px;"><?php if($fetch_cat['varStatus'] == "Active") { ?>
                                <a href="viewgall.php?flag=deactive&amp;cid=<?php echo $fetch_cat['catid'];?>"  class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="De-Activate">
								<span class="ui-icon ui-icon-unlocked"></span></a>
                                <?php } else { ?>
                                <a href="viewgall.php?flag=active&amp;cid=<?php echo $fetch_cat['catid'];?>"  class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Activate">
								<span class="ui-icon ui-icon-locked"></span></a><?php } ?></td> 
						 
						 
						    <td align="center" style="padding-left:18px;"><a href="addgall.php?flag=edit&amp;cid=<?php echo $fetch_cat['catid'];?>"class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit This Album">
							<span class="ui-icon ui-icon-pencil"></span>
							</a>
							
							</td> 
						    <td align="center" style="padding-left:40px;"><a href="viewgall.php?flag=delete&amp;cid=<?php echo $fetch_cat['catid'];?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Delete"><span class="ui-icon ui-icon-circle-close" onClick="return calldel('Do You Want To Delete This?');"></span></a></td> 
					      </tr> 
						  <?php 
          ...
          <tr>
            <td width="97%" align="right" class="test"><?php 					
					if($limit < $total)
					{
							...
							{       
								echo "<a href=\"viewgall.php?sortby=".$SortList."&page=" . ($page - 1) . "\" class='linksnew'>Prev</a>"; 
							}
							...
							{ 
								...
								{	 
									echo "<a href=\"viewgall.php?sortby=".$SortList."&page=$i\" class='linksnew'> $i</a>"."</font>"; 
								}
							} 
							...
							{     
								echo "<a href=\"viewgall.php?sortby=".$SortList."&page=" . ($page + 1) . "\" class='linksnew'>Next</a>";
							}
					}		
