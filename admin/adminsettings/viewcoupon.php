<?php include('header.php'); 
	...
	$limit  = $pager->limit; 
	$page   = $pager->page; 	
	 $Q_Check1	= "SELECT * FROM ".COUPON." WHERE `CouponCode` LIKE '$SortList%'  ORDER BY intCouponid DESC limit $offset, $limit";
...
<TR>
<TD width="10%" align="center" class="white">SI.NO</td>
<TD width="50%" align="left" class="white">Coupon Code </TD>
<td width="20" align="center" class="white">Discount Amount</td>
<TD width="10%" align="center" class="white">Lock</TD>
<!--<TD width="8%" align="center" class="white">Edit</TD>-->
<TD width="10%" align="center" class="white">Delete</TD>
</TR>
</tr>
</thead>
...
<tr align="c">
<TD align="center" class="white1">
<?php echo $i; ?></TD>
<TD align="center" class="white1"><?php echo $fetch1['CouponCode']; ?></TD>
<td align="center" class="white1"><?php echo $fetch1['Discountname']; if($fetch1['CouponType']==1) echo " %"; else echo " GBP" ?></td>
<td align="center">
<?php if($fetch1['varStatus'] == "Active") { ?>
                                <a href="viewcoupon.php?flag=deactive&amp;cid=<?php echo $fetch1['intCouponid'];?>&amp;page=<?php echo $page;?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Active">
								<span class="ui-icon ui-icon-unlocked"></span></a>
                                <?php } else { ?>
                                <a href="viewcoupon.php?flag=active&amp;cid=<?php echo $fetch1['intCouponid'];?>&amp;page=<?php echo $page;?>"  class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Deactive">
...
<td align="center">
<a href="viewcoupon.php?flag=delete&amp;cid=<?php echo $fetch1['intCouponid'];?>&amp;page=<?php echo $page;?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Delete this Product"><span class="ui-icon ui-icon-circle-close" onClick="return calldel('Do You Want Delete this Product?');"></span></a></td>
</tr>
