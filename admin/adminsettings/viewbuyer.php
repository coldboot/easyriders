...
<div id="page-wrapper">
		<div id="main-wrapper">
			<div id="main-content">
				<div class="title">
				<a name="viewcat"></a>	<h3>View Buyer</h3>
				</div>
  ...
  <tr>
           <td colspan="8" align="center">
					   <?php
						echo "<a class=\"leftlinks\" href=\"viewbuyer.php?sortby=all\">All</a>";?>
									  &nbsp;&nbsp;&nbsp;
									  <?php 		for($ASCII = 65; $ASCII <= 90 ; $ASCII++)
						{				
						  echo "<a class=\"leftlinks\" href=\"viewbuyer.php?sortby=".chr($ASCII)."\">".chr($ASCII)."</a>&nbsp;" ."&nbsp;";
						}	
					 ?>		 	</td>
  </tr>
  ...
  ?> 
					...
					<? if ($total== 0)
					 {
                    echo('<tr><td colspan="6" align="center"><center><span class = "red">Buyer List Not Found!</span><center></td></tr>');
                    }
                     else
                     {
                    echo ('
                     <tr>
						    ...
						    <th width="300" align="left">E-mail</th> 
				...
				if($total!="")
				{
					...
					?>
						<tr>
						    ...
						    <td><strong><center><?php echo $fetch_cat['varEmail'];?></strong></center></td> 
							<td style="padding-left:20px;"><a href="viewbuyerhistory.php?flag=deactive&amp;memberid=<?php echo $fetch_cat['intmemberid'];?>&page=<?php echo $_GET['page'];?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="View More Information"><span class="ui-icon ui-icon-folder-open"></span></a></td>
							
							
							     <td align="center" style="padding-left:20px;"><?php if($fetch_cat['varStatus'] == "DeActive") { ?>
								<div align="center"><a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="DeActivate" href="viewbuyer.php?flag=active&amp;memberid=<?php echo $fetch_cat['intmemberid'];?>&page=<?php echo $_GET['page'];?>">
								<span class="ui-icon ui-icon-locked"></span></a></div>
								<?php } else { ?>
								<div align="center">
								<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Activate" href="viewbuyer.php?flag=deactive&amp;memberid=<?php echo $fetch_cat['intmemberid'];?>&page=<?php echo $_GET['page'];?>">
								<span class="ui-icon ui-icon-unlocked"></span></a></div><?php } ?>
								</td> 
								
								   <td align="center" style="padding-left:20px;">
							<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit This Member" href="addbuyer.php?memberid=<?php echo $fetch_cat['intmemberid'];?>&page=<?php echo $_GET['page'];?>"><span class="ui-icon ui-icon-pencil"></span></a>
						    ...
						    <td align="center" style="padding-left:20px;">
							<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" href="viewbuyer.php?flag=delete&amp;memberid=<?php echo $fetch_cat['intmemberid'];?>&page=<?php echo $_GET['page'];?>" title="Delete"><span class="ui-icon ui-icon-circle-close" onClick="return calldel('Do You Want To Delete This Buyer?');"></span></a>
...
<?php 					
          ...
          <tr>
            <td width="97%" align="right" class="test">';
							...
							{       
								echo "<a href=\"viewbuyer.php?sortby=".$SortList."&page=" . ($page - 1) . "\" class='linksnew'>Prev</a>"; 
							}
							...
							{ 
								...
								{	 
									echo "<a href=\"viewbuyer.php?sortby=".$SortList."&page=$i\" class='linksnew'> $i</a>"."</font>"; 
								}
							} 
							...
							{     
								echo "<a href=\"viewbuyer.php?sortby=".$SortList."&page=" . ($page + 1) . "\" class='linksnew'>Next</a>";
							}
					}	echo'</td>
  </tr>
</table>';
