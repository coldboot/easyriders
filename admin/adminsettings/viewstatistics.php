<?php 
		...
		elseif($flag == "delete")
	{
 	...
 	$pagqry="SELECT * FROM `tbl_side_statistics`";
...
//$limit = 2; 
	...
	$page   = $pager->page; 	
 	...
 	$limqry		= "SELECT * FROM `tbl_side_statistics` WHERE `CountryName` LIKE '$SortList%' order by id DESC  limit $offset,$limit ";
...
<div id="page-wrapper">
		<div id="main-wrapper">
			<div id="main-content">
				<div class="title">
				<a name="viewcat"></a>	<h3>User Statistics</h3>
				</div>
...
<?php 					
          ...
          <tr>
            <td width="97%" align="right" class="test">';
							...
							{       
								echo "<a href=\"viewstatistics.php?sortby=".$SortList."&page=" . ($page - 1) . "\" class='linksnew'>Prev</a>"; 
							}
							...
							{ 
								...
								{	 
									echo "<a href=\"viewstatistics.php?sortby=".$SortList."&page=$i\" class='linksnew'> $i</a>"."</font>"; 
								}
							} 
							...
							{     
								echo "<a href=\"viewstatistics.php?sortby=".$SortList."&page=" . ($page + 1) . "\" class='linksnew'>Next</a>";
							}
					}	echo'</td>
  </tr>
</table>';
