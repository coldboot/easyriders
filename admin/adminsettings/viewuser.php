...
<div id="page-wrapper">
	...
	<TD width="39%" align="right" class="white" style="padding-left:50px;">
	 <b>Search User</b>	</TD>
	<td width="2%">&nbsp;	</td>
 ...
 <td>&nbsp;</td>
  ...
  <tr>
           <td colspan="8" align="center" style="padding-left:47px;">
					   <?php
						echo "<a class=\"leftlinks\" href=\"viewuser.php?sortby=all\">All</a>";?>
									  &nbsp;&nbsp;&nbsp;
									  <?php 		for($ASCII = 65; $ASCII <= 90 ; $ASCII++)
						{				
						  echo "<a class=\"leftlinks\" href=\"viewuser.php?sortby=".chr($ASCII)."\">".chr($ASCII)."</a>&nbsp;" ."&nbsp;";
						}	
					 ?>		 	</td>
  </tr>
  ...
  { 
	  if($rType == "active")
	  	$rDisp	=	"User Status Successfully Activated";
	  elseif($rType == "deactive")
	  	$rDisp	=	"User Status Successfully De-Activated";
	  elseif($rType == "delete")
				...
				<div class="hastable">
					...
					?>
						<tr>
						    ...
						    <td style="padding-left:150px;"><?php $user=$fetch_cat['Username']; $out=substr($user,0,20); echo ucfirst($out);?></td> 
                                ...
                                <?php } else { ?>
                                <a href="viewuser.php?flag=active&amp;cid=<?php echo $fetch_cat['intid'];?>"  class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="De-Active">
						    ...
						    <td align="center" style="padding-left:35px;"><a href="viewuser.php?flag=delete&amp;cid=<?php echo $fetch_cat['intid'];?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip"><span class="ui-icon ui-icon-circle-close" onClick="return calldel('Do You Want To Delete This User?');"></span></a></td> 
					      </tr> 
						  <?php 
