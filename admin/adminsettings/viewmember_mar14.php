				...
				<?php
					...
					?>
						<tr>
						    ...
						    <td><strong><center><?php echo $fetch_cat['varFirstname'];?></strong></center></td> 
							<td style="padding-left:20px;"><a href="viewmemberhistory.php?flag=deactive&amp;memberid=<?php echo $fetch_cat['intmemberid'];?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="View More Information"><span class="ui-icon ui-icon-folder-open"></span></a></td>
							
							    <td align="center" style="padding-left:20px;"><?php if($fetch_cat['varStatus'] == "Active") { ?>
								<div align="center"><a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Activate" href="viewmember.php?flag=deactive&amp;memberid=<?php echo $fetch_cat['intmemberid'];?>">
								<span class="ui-icon ui-icon-unlocked"></span></a></div>
								<?php } else { ?>
								<div align="center">
								<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="De-Activate" href="viewmember.php?flag=active&amp;memberid=<?php echo $fetch_cat['intmemberid'];?>">
								<span class="ui-icon ui-icon-locked"></span></a></div><?php } ?>
								</td> 
																
						    <td align="center" style="padding-left:20px;">
							<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit This Member" href="addmember.php?memberid=<?php echo $fetch_cat['intmemberid'];?>"><span class="ui-icon ui-icon-pencil"></span></a>
							
							</td> 
							
							
						    <td align="center" style="padding-left:20px;">
							<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" href="viewmember.php?flag=delete&amp;memberid=<?php echo $fetch_cat['intmemberid'];?>" title="Delete"><span class="ui-icon ui-icon-circle-close" onClick="return calldel('Do You Want To Delete This Member?');"></span></a>
