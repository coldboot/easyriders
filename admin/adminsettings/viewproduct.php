...
function ajaxfeature(str1,str2)
{
				...
				<div class="hastable">
					...
					?>
						<tr>
						    ...
						    <td style="text-align:center;"><span><?php echo ucfirst($fetch_cat['productname']);?></span></td> 
									<?php 
										list($width,$height)=getimagesize($path.$fetch_cat['productimage']);
					...
					<td><center><?php echo $fetch_cat['categoryid'];?></center></td>
					<!--<td><center><?php echo $fetch_cat['subcatid'];?></center></td>-->
					
					<td class="center"><center>
						<?php 
						
							if($fetch_cat['feastatus']=='true') $checked='checked="checked"'; 
							else $checked="";
						?>
						<input type="checkbox" value="<?php echo $fetch_cat['intproductid'];?>" name="feature" onchange="ajaxfeature(this.value,this.checked);" id="feature" <?php echo $checked; ?> />
					</center></td>
							<td align="center" style="padding-left:10px;">
							<?php if($fetch_cat['status'] == "Active") { ?>
							
                                <a href="viewproduct.php?flag=deactive&amp;cid=<?php echo $fetch_cat['intproductid'];?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="De-Activate">
								<span class="ui-icon ui-icon-unlocked"></span></a>
                                
                                
								<?php } else { ?><a href="viewproduct.php?flag=active&amp;cid=<?php echo $fetch_cat['intproductid'];?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Activate">
								
								<span class="ui-icon ui-icon-locked"></span></a><?php } ?>
								</td>
								 
						    <td align="center" style="padding-left:10px;"><a href="addproduct.php?cid=<?php echo $fetch_cat['intproductid'];?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Edit This Product">
							<span class="ui-icon ui-icon-pencil"></span>
							<!--	<img src="../../images/reply2.gif" border="0" title="Edit">-->
							</a></td> 
						    <td align="center" style="padding-left:10px;"><a href="viewproduct.php?flag=delete&amp;cid=<?php echo $fetch_cat['intproductid'];?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip" title="Delete This Product"><span class="ui-icon ui-icon-circle-close" onClick="return calldel('Do You Want To Delete This Product?');"></span></a></td> 
					      </tr> 
						  <?php $i++; } ?>
						</tbody>
						</table>
